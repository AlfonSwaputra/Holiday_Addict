...
CREATE TABLE `kategori_detail` (
  `id_kategori_detail` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_kategori_detail`),
...
INSERT INTO `preferences` VALUES (69,116,1,1,1,0,0,0,0),(70,117,0,1,1,1,0,0,0);
...
INSERT INTO `user_favorites` VALUES (23,116,53,'2025-03-12 22:14:32'),(32,117,52,'2025-03-15 21:35:19'),(60,117,53,'2025-03-15 21:46:54'),(86,117,13,'2025-03-17 21:30:52');
...
INSERT INTO `user_interactions` VALUES (1,116,14,'favorite','2025-03-13 16:24:09'),(2,116,24,'favorite','2025-03-13 21:56:21');
...
INSERT INTO `user_ratings` VALUES (4,116,'{\"6\": \"8\", \"17\": \"10\", \"13\": \"0\"}','2025-03-15 20:54:31','2025-03-15 21:18:16'),(10,117,'{\"17\": \"10\", \"14\": \"0\", \"24\": \"0\", \"13\": \"10\"}','2025-03-17 13:24:02','2025-03-17 21:31:46');
...
INSERT INTO `users` VALUES (116,'Altar Weasley','altarweasley@gmail.com','$2y$10$MY5eFtJt5pcDKvDqe0rRbul8U2jUTfCwccZ//cT.90UCvhjG8YUHe','1998-02-05','male'),(117,'Alfon Swaputra','alfonswaputra3@gmail.com','','0000-00-00','male');
...
DROP TABLE IF EXISTS `wisata_reviews`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wisata_reviews` (
  ...
  KEY `user_id` (`user_id`),
  KEY `wisata_id` (`wisata_id`),
  CONSTRAINT `wisata_reviews_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_user`),
  CONSTRAINT `wisata_reviews_ibfk_2` FOREIGN KEY (`wisata_id`) REFERENCES `wisata` (`id_wisata`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `wisata_reviews`
--

LOCK TABLES `wisata_reviews` WRITE;
/*!40000 ALTER TABLE `wisata_reviews` DISABLE KEYS */;
/*!40000 ALTER TABLE `wisata_reviews` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-18 13:00:08
